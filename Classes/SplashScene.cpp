...
{
	MoveBy* moveFu1ToLeft1 = MoveBy::create(MOVE_SPLEED, Vec2(-spriteSize.width, 0));
	fu1_Sprite->runAction(moveFu1ToLeft1);

	MoveBy* movePoToright = MoveBy::create(MOVE_SPLEED, Vec2(spriteSize.width, 0));
...
{
	MoveBy* moveFu1ToLeft2 = MoveBy::create(MOVE_SPLEED, Vec2(-spriteSize.width, 0));
	fu1_Sprite->runAction(moveFu1ToLeft2);

	MoveBy* Fu2_Sprite_MoveBy = MoveBy::create(MOVE_SPLEED, Vec2(spriteSize.width, 0));
...
{
	MoveBy* moveFu1ToLeft3 = MoveBy::create(MOVE_SPLEED, Vec2(-spriteSize.width, 0));
	fu1_Sprite->runAction(moveFu1ToLeft3);

	MoveBy* Weng_Sprite_MoveBy = MoveBy::create(MOVE_SPLEED, Vec2(spriteSize.width, 0));
